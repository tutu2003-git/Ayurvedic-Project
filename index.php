...
<div class="hero row" id="main-hero">
        <div class="title">
            <div>
                <span class="playfair">  Ayurvedic  &amp;  wellness </span>
        ...
        <a href="#" class="btn btn-default">Explore Thrimal</a>
    </div> <!-- end of hero -->
    ...
    <div class="about-resort">
        <div class="row">
                ...
                <div class="about-slider">
                    <div>
                        <div class="col col-sm-8 col-sm-offset-2 col-lg-8 col-lg-offset-2 section-title">
                            <h3>We are Thrimal Ayurvedic Treatment Center </h3>
                            <p>Thrimal Ayurvedic Treatment Center is a premier wellness destination dedicated to providing holistic Ayurvedic treatments and therapies. Our center combines ancient Ayurvedic wisdom with modern techniques to offer a range of treatments aimed at promoting overall health and well-being.</p>
                        </div>
                        <img src="images/about/slider/slider-1.jpg" alt="Slide Picture" class="img img-responsive">
                    </div>
                    <div>
                        <div class="col col-sm-8 col-sm-offset-2 col-lg-8 col-lg-offset-2 section-title">
                            <h3>We are Thrimal ayurvedic </h3>
                            <p>Our mission is to help individuals achieve balance and harmony in their lives through natural and traditional Ayurvedic methods. We strive to create a nurturing and healing environment where our clients can rejuvenate their mind, body, and spirit.</p>
                        </div>
                        <img src="images/about/slider/slider-1.jpg" alt="Slide Picture" class="img img-responsive">                
                    </div>
                </div>
            ...
            <section class="resort col col-sm-6">
                ...
                <div class="title">
                    <h2>Thrimal </h2>
                    <p class="playfair">Ayurvedic Treatment Center</p>
                </div>
            ...
            <div class="row">
                <div class="beautifull-spa col col-sm-6">
                    <div class="col col-sm-6 col-sm-push-6">
                      <h2>Thrimal center with soothing environment</h2>
                    </div>

                    <div class="col col-sm-6 col-sm-pull-6">
                        <p>our beautiful ayurvedic center offer soothing environment in which you can rest, relax and feel competely rejuvenated</p>
                    </div>
                </div>
                ...
                <div class="faeture col col-md-6">
                    <div class="col col-xs-6" id="first-box">
                        ...
                        <p>Experience comprehensive care that addresses physical, mental, and spiritual well-being.</p>
                    </div>
                    <div class="col col-xs-6" id="second-box">
                        <i class="flaticon-three"></i>
                        <h3>Stress Relief</h3>
                        <p>Alleviate stress and promote relaxation with calming treatments such as Shirodhara and Abhyanga massages.</p>
                    </div>
                    <div class="col col-xs-6" id="third-box">
                        <i class="flaticon-fruit"></i>
                        <h3>Natural Remedies</h3>
                        <p>Benefit from the use of natural, herbal remedies and oils with no synthetic chemicals or side effects.</p>
                    </div>
                    <div class="col col-xs-6" id="fourth-box">
                        <i class="flaticon-flower"></i>
                        <h3>Detoxification</h3>
                        <p>Cleanse your body of toxins through effective detox therapies like Panchakarma.</p>
                    </div>
                </div>
            </div> <!-- end of row -->
...
<section class="fun-fact">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col col-xs-6 col-sm-3">
                    ...
                    <span class="fact-title playfair">Comments</span>
                </div>
                <div class="col col-xs-6 col-sm-3">
        ...
        <div class="container">
            <div class="row">
                <div class="section-title col col-lg-8 col-lg-offset-2">
                    <span class="playfair">Thrimal Advantages</span>
                    <h2>Good for your health</h2>
                    <p>Visit Thrimal Ayurvedic Treatment Center to experience these unique advantages and embark on a journey toward holistic health and well-being.</p>
                </div>
            </div>
                ...
                <div class="advantages col col-md-6">
                    <div class="row" id="first-advantage">
                        ...
                        <div class="col col-xs-10">
                            <span class="playfair">Experienced Practitioners:</span>
                            <h3>Our team of skilled Ayurvedic practitioners, with years of experience, ensures you receive the best care possible.</h3>
                        </div>
                    </div>
                    <div class="row" id="second-advantage">
                        ...
                        <div class="col col-xs-10">
                            <span class="playfair">Holistic Approach</span>
                            <h3>We treat the whole person—mind, body, and spirit—using natural, time-tested Ayurvedic methods.</h3>
                        </div>
                    </div>
    ...
    </section> <!-- end of Thrimal-advantages -->
                ...
                <div class="right col col-md-6">
                    <div class="facial-right-thumbnail thumbnail">
                        <div class="victorial-facila-massage row">
                            <h4><span>Shirodhara</span></h4>
                            <p>Service Hours: 08.00am-10.00pm, </p>
                            <a href="#" class="btn btn-default">View Thrimal gallery</a>
                ...
                <div class="right col col-md-6">
                    <div class="body-left-thumbnail thumbnail">
                        <div class="victorial-body-massage row">
                            <h4>  <span>Full Body Massage</span></h4>
                            <p>Service Hours: 08.00am-10.00pm</p>
                            <a href="#" class="btn btn-default">View Thrimal photo gallery</a>
                            <div class="like-comment">
                                <a href="#"><i class="flaticon-shapes">125 Likes</i></a>
                                <a href="#"><i class="flaticon-interface-2">125 Comments</i></a>
                            </div>
            ...
            <div class="row">
                <div class="news col col-md-6">
                    <div class="portfolio">
                        ...
                        <p class="playfair"> "Thrimal Ayurvedic Center transformed my life. After years of chronic pain and stress, I found relief and hope here. The serene environment and compassionate staff made me feel truly cared for. Their personalized treatments and ancient Ayurvedic practices brought me balance and peace. The herbal therapies and massages rejuvenated my body, while their holistic approach nurtured my mind and spirit. I am forever grateful to Thrimal for giving me my life back."</p>
                
                    </div> <!-- end of portfolio -->

                    <h3>THrimal Ayurvedic <span>&amp; Treatment Center</span></h3>

                    <div class="sort-about">
                        <p></p>
                        <p class="playfair">“our beautiful ayurvedic center offer soothing environment in which you can rest, relax and feel competely rejuvenated.”</p>
        ...
        <section class="booking col col-sm-10 col-sm-offset-1" id="book">
            ...
            <div class="col col-lg-10 col-lg-offset-1 content">
                <div class="section-title">
                    <div class="pull-left">
                        <h3>Appointment</h3>
                        <p class="playfair">"Thrimal Ayurvedic Center offers excellent treatments in a soothing and beautiful environment."</p>
                    </div>
            ...
            <div class="row content">
                <div class="col col-xs-4" id="left-member">
                    <div class="thumbnail">
                        ...
                        <div>
                            <p>Lusia Gracia</p>
                            <span class="playfair">Thrimal Owner</span>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="victoria col col-xs-6 col-md-3">
                    ...
                    <p>Thrimal Ayurvedic Center offers excellent treatments in a soothing and beautiful environment. </p>
                    <ul class="nav navbar-nav">
                        <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                        <li><a href="#"><i class="fa fa-behance"></i></a></li>
                ...
                <div class="footer-about col col-xs-6 col-md-3">
                    <h2>About Thrimal</h2>
                    <ul>
                        <li>Thrimal Ayurvedic&amp; Treatment Center</li>
                        <li>Address</li>
                        <li>kashapayagama, habarana srilanka</li>
                        <li>NV 891009</li>
            ...
            <div class="row copyright">
                <div class="col col-md-6">
                    <p><a href="#">Thrimal</a> Made with love by themexriver &copy; <span>2015</span> All Right Reserved</p>
                </div>
